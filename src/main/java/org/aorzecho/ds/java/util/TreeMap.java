...
package org.aorzecho.ds.java.util;
 ...
 * @author Arkadiusz Orzechowski, 2012 (order statistics mod)
 * @see Map
 * @see HashMap
 * @see Hashtable
 * @see Comparable
    ...
    implements NavigableMap<K,V>, Cloneable, java.io.Serializable
{
	 ...
	 *    
	 * @param i between 1 and size()
	 * @return i-th value in order of this tree
	 */
    public V getIthValue(int i) {
    	Entry<K,V> p = getIthEntry(root, i);
    	return p.getValue();
    }
	 ...
	 *    
	 * @param i between 1 and size()
	 * @return i-th key in order of this tree
	 */
    public K getIthKey(int i) {
    	Entry<K,V> p = getIthEntry(root, i);
    	return p.getKey();
    }
	...
	/**
	 * Returns n-th entry in order of given root node. The implementation provides guaranteed
	 * log(n) time cost for this operation. 
	 *    
	 * @param i between 1 and size()
	 * @return
    ...
    private void deleteEntry(Entry<K,V> p) {
        ...
        for (Entry<K,V> parent = p.parent; parent != null; parent = parent.parent)
        	parent.size--;
